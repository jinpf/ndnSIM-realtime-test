...
main (int argc, char *argv[])
{
  ...
  ndn::AppHelper consumerHelper ("ns3::ndn::ConsumerS");
  ...
  ndn::AppHelper producerHelper ("ns3::ndn::ProducerSS");
  ...
  ndn::AppPacketTracer::InstallAll ("scratch/subdir/record/line-sync-packet-record.txt");
